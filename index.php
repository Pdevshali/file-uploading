...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Stick+No+Bills:wght@600;800&display=swap" rel="stylesheet">
	...
	<div class="file__upload">
			<div class="header">
				<p><i class="fa fa-cloud-upload fa-2x"></i><span><span>up</span>load</span></p></div>
